...
class ImageProcessor():
    ...
    def process_image(self, msg):
        ...
        return self.parallel_executor.execute([detection_job, depth_est_job])
    ...
    def estimate_depth_and_save_image(self, tensor, name):
        ...
        normalized_image = torchvision.transforms.ToPILImage()(depth_tensor.squeeze(0))

        normalized_image.save(self.depth_images_folder + name + '.png')
